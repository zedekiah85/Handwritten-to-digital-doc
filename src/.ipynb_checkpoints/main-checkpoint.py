...
def infer(model: Model, fn_img: path) -> None:
    ...
    result = f'Recognized: "{recognized[0]}" Probability: {probability[0]}'
    return result
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--img_file', help='Image used for inference.', type=Path, default='../data/ttest.jpeg')
...
# app = gr.Interface(fn = infer, 
#                      inputs = 'image',
#                      outputs = gr.outputs.Textbox(), 
#                      title = 'Handwritten to Digital documents Application',
